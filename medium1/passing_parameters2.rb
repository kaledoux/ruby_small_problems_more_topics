...
#
# Based on the examples shown above, write a method that takes an array as an argument. The method should yield the contents of the array to a block, which should assign
...
birds = %w(finch lark hawk osprey eagle)
make_raptors(birds) { |bird1, bird2, *raptors| raptors.each {|b| puts b}}


# also it is considered good practice to leave ununsed parameters as _
make_raptors(birds) { |_, _, *raptors| raptors.each {|b| puts b}}
