...
#   not used. The object that is passed to the block is defined as an
#   argument to each_with_object; with each iteration, this object may be
#   updated by the block. When iteration is complete, the final value of
